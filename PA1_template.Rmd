...
```
Time interval with maximum number of steps is `r timeInterval` (hhmm)
...
The original total steps were `r originalTotalSteps`. The new total steps estimated were `r newTotalSteps`.
